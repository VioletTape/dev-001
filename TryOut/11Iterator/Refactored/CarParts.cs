...
namespace TryOut._11Iterator.Refactored {
    public interface ICarPart  {
        ...
        ReadOnlyCollection<ICarPart> GetParts();
    }
    ...
    public abstract class CompositeNode : ICarPart {
        ...
        public ReadOnlyCollection<ICarPart> GetParts() {
            return new ReadOnlyCollection<ICarPart>(carParts);
        }
    ...
    public abstract class Node : ICarPart {
        ...
        public ReadOnlyCollection<ICarPart> GetParts() {
            return new List<ICarPart>().AsReadOnly();
        }
    }
